...
*/
Stinuum.Imagemarking.prototype.show = function(canvasID){
...
Stinuum.Imagemarking.drawBackRadar = function(image_id) {
    var image_canvas = document.getElementById(image_id);

    if (image_canvas.getContext) {
        var h_width = image_canvas.width / 2;
        var h_height = image_canvas.height / 2;
...
Stinuum.Imagemarking.prototype.updateAvgVelocity = function(){
